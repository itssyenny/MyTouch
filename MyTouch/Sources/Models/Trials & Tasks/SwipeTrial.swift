...
class SwipeTrial: Trial {
    ...
    override init(trial: ORKTouchAbilityTrial) {
        ...
        if let trial = trial as? ORKTouchAbilitySwipeTrial {
            ...
            NSLog("Acceleration in SwipeTrial, x: %f y: %f z: %f", self.coreMotionAccelerometer.x, self.coreMotionAccelerometer.y, self.coreMotionAccelerometer.z)
            NSLog("Gyroscope in SwipeTrial, x: %f y: %f z: %f", self.coreMotionGyroscope.x, self.coreMotionGyroscope.y, self.coreMotionGyroscope.z)
            NSLog("Device Motion in SwipeTrial, x: %f y: %f z: %f", self.coreMotionDeviceMotion.x, self.coreMotionDeviceMotion.y, self.coreMotionDeviceMotion.z)
        }
    }
